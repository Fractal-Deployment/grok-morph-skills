...
|--------------|--------------|-----------|---------------------|
| **honest-prompt-rewrite** | Rewrite the working prompt each round under Logic·Ration·Reason | Shared think↔research loop; keep telos fixed; mint markers | Closing train_ok / Ω from eloquence |
